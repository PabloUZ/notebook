[← Back to database](../docker-setup.md) | [← Back to index](../../index.md)
...
- How to install Mongoose and required packages
- How to configure environment variables for MongoDB
- How to set up Mongoose module in NestJS
- How to construct MongoDB connection strings
...
Now that Mongoose is configured, learn how to create and use schemas:

**Continue with:** [Using Mongoose](./usage.md)

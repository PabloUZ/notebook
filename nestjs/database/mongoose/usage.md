...
Learn how to create schemas and use Mongoose decorators to interact with your MongoDB database.
...
- How to use Mongoose decorators (@Schema, @Prop)
- How to configure schema and property options
- How to inject and use models
- Common model methods (find, create, update, delete)
- Advanced features (population, aggregation, filtering)

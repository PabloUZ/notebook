...
Learn how to create entities and use TypeORM decorators to interact with your SQL database.
...
- How to create entity files
- How to use TypeORM decorators (@Entity, @Column, etc.)
- How to configure column options
- How to inject and use repositories
- Common repository methods (find, create, update, delete)
- Advanced features (timestamps, relations)

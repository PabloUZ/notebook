...
Learn how to expose gRPC handlers in your microservice and how to consume them from an API Gateway.
...
- How to expose gRPC handlers with `@GrpcMethod`
- How to register a `ClientGrpc` in the API Gateway using the shared `.proto` file
- How to call the microservice through a typed service instance
